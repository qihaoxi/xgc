...
add_xgc_test(test_descriptor_substrate ${XGC_PROJECT_ROOT}/tests/test_descriptor_substrate.c)
add_xgc_test(test_heap_substrate ${XGC_PROJECT_ROOT}/tests/test_heap_substrate.c)
add_xgc_test(test_reclaim_substrate ${XGC_PROJECT_ROOT}/tests/test_reclaim_substrate.c)
add_xgc_test(test_runtime_invariants_substrate ${XGC_PROJECT_ROOT}/tests/test_runtime_invariants_substrate.c)
add_xgc_test(test_worklist_substrate ${XGC_PROJECT_ROOT}/tests/test_worklist_substrate.c)
